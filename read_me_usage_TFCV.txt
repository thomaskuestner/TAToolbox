1. Start main_runGUI()
2. Select already existing data or new data to calculate
3. Leftmost of the GUI - Right of the Tab "bekannte Studien" click "+"
4. Click "Wähle die gewünschten Datensaetze aus"
5. Choose your datasets
6. In the middle of the GUI - Right of the Tab "bekannte ROIs" click "ROI laden"
7. Click Lade Maske(n) ein
8. Choose you ROI/mask file
...
14. Click "Speichere diese Studie"
15. Click "Yes"
