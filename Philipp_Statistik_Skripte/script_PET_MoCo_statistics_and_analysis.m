...
counter = 1;
datatype = inputdlg(sprintf('1 = all TFs from all the 3 different types of data\n2 = DICOM and CORRECTED Data\n3 = Only GATED Data'),'Please enter one of the below discribed numbers',1,{'2'}); 
